...
function cp_decrypt( $encrypted ) {
    ...
    // Get encryption version from encoded string
...
function cp_encrypt_v1( $plaintext )
{
    ...
    // Set cipher method to CBC with 256-bit key
    $cipher = 'aes-256-cbc';
    ...
    // Return encryption version and base64 encoding of ciphertext, hash, iv, salt_key, and salt_hmac
 ...
 *
 * @param string $encypted - encryption version and base64 encoding of
 *                         - ciphertext, hash, iv, salt_key, and salt_hmac
 */
...
function cp_decrypt_v1( $encrypted )
{
    ...
    // Extract encryption version and base64 encoded data from string
    ...
    // Variable to compare with $hash for HMAC authentication
    ...
    if ( hash_equals( $hash, $digest ) ) {
        ...
        return '<strong>Warning: </strong>Please verify authenticity of ciphertext.';
    }
